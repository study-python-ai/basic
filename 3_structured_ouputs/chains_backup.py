...
draft_prompt = ChatPromptTemplate.from_messages([
    ("system", "You are an expert AI researcher. Provide a detailed ~250-word answer with reflection and search queries."),
    MessagesPlaceholder(variable_name="messages"),
])

# 수정 프롬프트  
revise_prompt = ChatPromptTemplate.from_messages([
    ("system", "Revise your previous answer using the new search information. Keep it under 250 words and add references."),
    MessagesPlaceholder(variable_name="messages"),
])
